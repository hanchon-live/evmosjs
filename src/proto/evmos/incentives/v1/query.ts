...
export namespace evmos.incentives.v1 {
    ...
    export class QueryIncentivesResponse extends pb_1.Message {
        ...
        get incentives() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.evmos.incentives.v1.Incentive, 1) as dependency_3.evmos.incentives.v1.Incentive[];
        }
        ...
        static fromObject(data: {
            ...
            if (data.incentives != null) {
                message.incentives = data.incentives.map(item => dependency_3.evmos.incentives.v1.Incentive.fromObject(item));
            }
            if (data.pagination != null) {
        ...
        toObject() {
            ...
            if (this.incentives != null) {
                data.incentives = this.incentives.map((item: dependency_3.evmos.incentives.v1.Incentive) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.incentives !== undefined)
                writer.writeRepeatedMessage(1, this.incentives, (item: dependency_3.evmos.incentives.v1.Incentive) => item.serialize(writer));
            if (this.pagination !== undefined)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryIncentivesResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.incentives, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.evmos.incentives.v1.Incentive.deserialize(reader), dependency_3.evmos.incentives.v1.Incentive));
                        break;
                    case 2:
    ...
    export class QueryIncentiveResponse extends pb_1.Message {
        ...
        get incentive() {
            return pb_1.Message.getWrapperField(this, dependency_3.evmos.incentives.v1.Incentive, 1) as dependency_3.evmos.incentives.v1.Incentive;
        }
        ...
        static fromObject(data: {
            ...
            if (data.incentive != null) {
                message.incentive = dependency_3.evmos.incentives.v1.Incentive.fromObject(data.incentive);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryIncentiveResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.incentive, () => message.incentive = dependency_3.evmos.incentives.v1.Incentive.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryGasMetersResponse extends pb_1.Message {
        ...
        get gas_meters() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_3.evmos.incentives.v1.GasMeter, 1) as dependency_3.evmos.incentives.v1.GasMeter[];
        }
        ...
        static fromObject(data: {
            ...
            if (data.gas_meters != null) {
                message.gas_meters = data.gas_meters.map(item => dependency_3.evmos.incentives.v1.GasMeter.fromObject(item));
            }
            if (data.pagination != null) {
                message.pagination = dependency_1.cosmos.base.query.v1beta1.PageResponse.fromObject(data.pagination);
            }
        ...
        toObject() {
            ...
            if (this.gas_meters != null) {
                data.gas_meters = this.gas_meters.map((item: dependency_3.evmos.incentives.v1.GasMeter) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.gas_meters !== undefined)
                writer.writeRepeatedMessage(1, this.gas_meters, (item: dependency_3.evmos.incentives.v1.GasMeter) => item.serialize(writer));
            if (this.pagination !== undefined)
                writer.writeMessage(2, this.pagination, () => this.pagination.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryGasMetersResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.gas_meters, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.evmos.incentives.v1.GasMeter.deserialize(reader), dependency_3.evmos.incentives.v1.GasMeter));
                        break;
                    case 2:
                        reader.readMessage(message.pagination, () => message.pagination = dependency_1.cosmos.base.query.v1beta1.PageResponse.deserialize(reader));
                        break;
    ...
    export class QueryParamsResponse extends pb_1.Message {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_2.evmos.incentives.v1.Params, 1) as dependency_2.evmos.incentives.v1.Params;
        }
        ...
        static fromObject(data: {
            ...
            if (data.params != null) {
                message.params = dependency_2.evmos.incentives.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_2.evmos.incentives.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
