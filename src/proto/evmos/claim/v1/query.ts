...
export namespace evmos.claim.v1 {
    ...
    export class QueryTotalUnclaimedResponse extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.coins !== undefined)
                writer.writeRepeatedMessage(1, this.coins, (item: dependency_3.cosmos.base.v1beta1.Coin) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryTotalUnclaimedResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.coins, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_3.cosmos.base.v1beta1.Coin.deserialize(reader), dependency_3.cosmos.base.v1beta1.Coin));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryParamsResponse extends pb_1.Message {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_5.evmos.claim.v1.Params, 1) as dependency_5.evmos.claim.v1.Params;
        }
        ...
        static fromObject(data: {
            ...
            if (data.params != null) {
                message.params = dependency_5.evmos.claim.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_5.evmos.claim.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryClaimRecordsRequest extends pb_1.Message {
        ...
        static fromObject(data: {
            ...
            const message = new QueryClaimRecordsRequest({});
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryClaimRecordsRequest {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryClaimRecordsRequest();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): QueryClaimRecordsRequest {
            return QueryClaimRecordsRequest.deserialize(bytes);
        }
    }
    export class QueryClaimRecordsResponse extends pb_1.Message {
        ...
        get claims() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_4.evmos.claim.v1.Claim, 2) as dependency_4.evmos.claim.v1.Claim[];
        }
        ...
        static fromObject(data: {
            ...
            const message = new QueryClaimRecordsResponse({});
            if (data.initial_claimable_amount != null) {
                message.initial_claimable_amount = data.initial_claimable_amount;
            }
            if (data.claims != null) {
                message.claims = data.claims.map(item => dependency_4.evmos.claim.v1.Claim.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.claims != null) {
                data.claims = this.claims.map((item: dependency_4.evmos.claim.v1.Claim) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.claims !== undefined)
                writer.writeRepeatedMessage(2, this.claims, (item: dependency_4.evmos.claim.v1.Claim) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryClaimRecordsResponse {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new QueryClaimRecordsResponse();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.claims, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_4.evmos.claim.v1.Claim.deserialize(reader), dependency_4.evmos.claim.v1.Claim));
                        break;
                    default: reader.skipField();
                }
            }
        ...
        static deserializeBinary(bytes: Uint8Array): QueryClaimRecordsResponse {
            return QueryClaimRecordsResponse.deserialize(bytes);
        }
    }
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            ...
            ClaimRecords: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryClaimRecordsRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryClaimRecordsRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryClaimRecordsResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryClaimRecordsResponse.deserialize(new Uint8Array(bytes))
            }
        };
    ...
    export class QueryClient extends grpc_1.makeGenericClientConstructor(UnimplementedQueryService.definition, "Query", {}) {
        ...
        ClaimRecords: GrpcUnaryServiceInterface<QueryClaimRecordsRequest, QueryClaimRecordsResponse> = (message: QueryClaimRecordsRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryClaimRecordsResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryClaimRecordsResponse>, callback?: grpc_1.requestCallback<QueryClaimRecordsResponse>): grpc_1.ClientUnaryCall => {
            return super.ClaimRecords(message, metadata, options, callback);
        };
    }
}
