...
export namespace evmos.claim.v1 {
    ...
    export class ClaimRecordAddress extends pb_1.Message {
        constructor(data?: any[] | {
            address?: string;
        ...
        static fromObject(data: {
            ...
            const message = new ClaimRecordAddress({});
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ClaimRecordAddress {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ClaimRecordAddress();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): ClaimRecordAddress {
            return ClaimRecordAddress.deserialize(bytes);
        }
    }
    export class ClaimRecord extends pb_1.Message {
        constructor(data?: any[] | {
            initial_claimable_amount?: string;
            actions_completed?: boolean[];
        }) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ClaimRecord {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ClaimRecord();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): ClaimRecord {
            return ClaimRecord.deserialize(bytes);
        }
    }
}
