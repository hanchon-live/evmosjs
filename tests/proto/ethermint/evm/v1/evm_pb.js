...
proto.ethermint.evm.v1.ChainConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    catalystBlock: jspb.Message.getFieldWithDefault(msg, 16, ""),
...
/**
 * optional string catalyst_block = 16;
 * @return {string}
 */
proto.ethermint.evm.v1.ChainConfig.prototype.getCatalystBlock = function() {
 ...
 * @return {!proto.ethermint.evm.v1.ChainConfig} returns this
 */
proto.ethermint.evm.v1.ChainConfig.prototype.setCatalystBlock = function(value) {
